    ...
    <style>
        ...
        *,::after,::before {
        ...
        .hero-content {
            position: relative;
            z-index: 1;
            color: #fff; /* Make the text white for more contrast */
...
<body>
    ...
    <section class="hero">
        <div class="hero-content container">
            ...
            <p>Efficiently manage employees and departments with a user-friendly interface.</p><br>
